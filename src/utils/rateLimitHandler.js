// Rate limiting utilities for desktop app
export class DesktopRateLimitHandler {
  constructor() {
...
export const desktopRateLimitHandler = new DesktopRateLimitHandler();

// Helper function to handle API errors with rate limiting
export const handleDesktopApiError = (error) => {
  
  const rateLimitResult = desktopRateLimitHandler.handleRateLimitError(error);
  
  if (rateLimitResult.isRateLimited) {
    return {
      type: 'rate_limit',
      message: desktopRateLimitHandler.getUserFriendlyMessage(rateLimitResult),
